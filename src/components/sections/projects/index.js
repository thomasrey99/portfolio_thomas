            ...
            return (
              ...
              >
                ...
                <div className="py-[2rem] flex flex-col justify-center items-start">
                  ...
                  <a className="cursor-pointer bg-primary text-white py-[0.8rem] px-[2rem] text-[1rem] uppercase tracking-[1px] inline-block font-bold rounded-[5px] shadow-[0_5px_15px_0_rgba(0,0,0,0.15)] transition-transform duration-300">
                    Details
                  </a>
                </div>
              </div>
