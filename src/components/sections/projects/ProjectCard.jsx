    ...
    return (
        ...
        >
            ...
            <div className="py-[2rem] flex flex-col justify-center items-center md:items-start">
                ...
                <Link href={`/${language}/projects/${project.id}`} className="cursor-pointer bg-primary text-white py-[0.8rem] px-[3rem] text-[1rem] uppercase tracking-[1px] inline-block font-bold rounded-[5px] shadow-[0_5px_15px_rgba(0,0,0,0.15)] transition-all duration-300 hover:translate-y-[-3px]">
                    {traduction.viewButton}
                </Link>
            </div>
        </div>
    )
